 ...
 */
public class GitLab401UnauthorizedMessageException extends GitLabMessageException
{
  ...
  public GitLab401UnauthorizedMessageException(final String message)
  {
    super(message);
  }

  public GitLab401UnauthorizedMessageException(final Throwable cause)
  {
    super(cause);
  }
}
