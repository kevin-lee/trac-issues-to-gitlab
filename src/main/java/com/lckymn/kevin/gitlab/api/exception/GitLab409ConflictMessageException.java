 ...
 */
public class GitLab409ConflictMessageException extends GitLabMessageException
{
  ...
  public GitLab409ConflictMessageException(final String message)
  {
    super(message);
  }

  public GitLab409ConflictMessageException(final Throwable cause)
  {
    super(cause);
  }
}
